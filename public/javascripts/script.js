	...
	3: [function(t, e, n) {
		...
		const ne = class extends HTMLElement {
			...
			hoverFloatLeft() {
				...
				document.getElementById("visualizer").appendChild(this.floatIndi);
			...
			floatLeft() {
				...
				document.getElementById("visualizer").style.marginLeft = pos.width+"px";
				this.offsetX = 0,
				this.offsetY = 0,
				this.style.setProperty("--x", `${this.offsetX}px`),
				this.style.setProperty("--y", `${this.offsetY}px`)
			...
			endFloatLeft() {
				document.getElementById("visualizer").style.marginLeft = null;
